...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(ev)
    ...
    if client.name == "omnisharp" or client.name == "omnisharp_mono" or client.name == "omnisharp-mono" then
...
-- vim.api.nvim_create_autocmd("LspAttach", {
--   group = vim.api.nvim_create_augroup("IncreaseTimeout", {}),
--   callback = function(args)
--     local client = vim.lsp.get_client_by_id(args.data.client_id)
--     if client and client.name == "omnisharp" then
--       client.config.flags = { allow_incremental_sync = true }
--       client.config.init_options = { timeout = 300000 } -- Increase to 5 minutes if needed
--     end
--   end,
-- })
